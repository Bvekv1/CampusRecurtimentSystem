...
<form method="POST" action="/postJob">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="inputJobRole" name="JobRole" placeholder="JobRole">
    </div>
    <div class="form-group">
        <label for="inputPositionLevel">PositionLevel</label>
        <input type="text" class="form-control" id="inputPositionLevel" name="PositionLevel" placeholder="PositionLevel">
    </div>
    <div class="form-group">
        <label for="inputDepartment">Department</label>
        <input type="text" class="form-control" id="inputPositionLevel" name="Department" placeholder="Department">
    </div>
    <div class="form-group">
    ...
    <input type="hidden" class="form-control" id="companyUserId" name="CompanyUserId" value=" {{Auth::user()->id}}">
